...
public class ClasspathFileResourceReaderTest {
    ...
    public void should_return_class_path_file_content() {
        ClasspathFileResourceReader reader = new ClasspathFileResourceReader("foo.response", Optional.<Charset>absent());
    ...
    public void should_throw_exception_when_file_does_not_exist() {
        ClasspathFileResourceReader reader = new ClasspathFileResourceReader("unknown.response", Optional.<Charset>absent());
